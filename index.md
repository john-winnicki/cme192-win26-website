...
- We will also post slides and live scripts on [Canvas](https://canvas.stanford.edu/courses/218100) and the course [GitHub](https://github.com/john-winnicki/cme192-win26).
...
- This **[anonymous form](https://docs.google.com/forms/d/e/1FAIpQLSfC1_UB7IWOZB4XAdD7dJ2UOroMF0oYJydKtCtISRPIr7_Qqg/viewform?usp=dialog)** is available to report issues and concerns.
...
To get started with MATLAB, we recommend checking out [this page](https://content.mathworks.com/viewer/67b7a53c1a8681508f4d03e0) created by MathWorks for ICME students. Next, you can browse the following online resources:
- MathWorks tutorials: [mathworks.com/support/learn-with-matlab-tutorials.html](https://www.mathworks.com/support/learn-with-matlab-tutorials.html)  
- Coursera specialization: [coursera.org/specializations/matlab-programming-engineers-scientists](https://www.coursera.org/specializations/matlab-programming-engineers-scientists)  
- Northwestern intro PDF: [mccormick.northwestern.edu/.../introduction-to-matlab.pdf](https://www.mccormick.northwestern.edu/documents/students/undergraduate/introduction-to-matlab.pdf)  
- Tutorialspoint: [tutorialspoint.com/matlab/index.htm](https://www.tutorialspoint.com/matlab/index.htm)  

MATLAB is quite similar to Python, and there are many resources bridging the two languages. For example:
- [blogs.mathworks.com/.../introduction-to-matlab-for-python-users](https://blogs.mathworks.com/student-lounge/2021/02/19/introduction-to-matlab-for-python-users/)

### MATLAB license and installation
MATLAB is available to Stanford students through the university’s academic license. You may choose to work in MATLAB Online or install the full desktop version. To install the desktop version, follow the instructions [at this page](https://www.mathworks.com/academia/tah-portal/stanford-university-30569029.html). There is no setup required for MATLAB Online: simply login to your stanford account [at this page](https://www.mathworks.com/products/matlab-online.html). 

- Stanford MATLAB license info: [uit.stanford.edu/service/softwarelic/matlab](https://uit.stanford.edu/service/softwarelic/matlab)  
- MATLAB on Sherlock cluster: [sherlock.stanford.edu/docs/software/using/matlab](https://www.sherlock.stanford.edu/docs/software/using/matlab)  
...
- CAPS & Wellness: [vaden.stanford.edu/caps-and-wellness/counseling-and-psychological-services-caps](https://vaden.stanford.edu/caps-and-wellness/counseling-and-psychological-services-caps)
...
- OAE site: [oae.stanford.edu](https://oae.stanford.edu)  
